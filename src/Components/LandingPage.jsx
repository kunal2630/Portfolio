            ...
            <Box sx={{ flexGrow: 1 }}>
                <Grid container direction="row"
                    ...
                    <Grid size={9}>
                        ...
                        <div className="text-6xl my-4 font-bold">
                            <Typewriter
                                words={['Kishlay Kunal.']}
                                loop={30}
                                cursor
